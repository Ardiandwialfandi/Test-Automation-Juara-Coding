...
//    }
    ...
    public void klik_grid_ke_tiga() {
        ...
        RegularPage.delayDuration(1);
        driver.navigate().to("https://dev.ptdika.com/web_jc_v2/admin/about?page_about=3");
    }
...
//    }
    ...
    public void menampilkan_data_list_ke_tiga() {
        ...
        RegularPage.delayDuration(2);
        String exp = ap.result(RegularPage.listGrids);
        Assert.assertEquals(ap.result(RegularPage.listGrids),exp);
    }
